...
def sound():
        ...
        if 'recording' in musicName:
            os.startfile('C:\\Users\\Sharadhi\\Music\\Recording.m4a') 
...
def TaskExe():
    ...
    while True:
        ...
        if 'who am i' in query:
            ...
            subprocess.Popen('C:\\Windows\\System32\\CameraSettingsUIHost.exe')

        elif 'open chrome' in query:
            subprocess.Popen('C:\\Users\\Sharadhi\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe') 
        ...
        #     print(eval_binary_expr(*(my_string.split())))
            ...
            web.open("https://www.youtube.com/@YouTube")
...
# importing datetime module for now()
    ...
    # Printing value of now.
        ...
        #     subprocess.call(["shutdown", "/r"])
            ...
            # Speak(m)
            Speak("in how many seconds i should remind u")
            time=  TakeCommand()
            time = int(time)
            # Speak(time)
            time=time*60
